<x-layout>
    ...
    <div>
        <h3 class="ejerciciosRutina"><a data-bs-toggle="#ejercicios-pierna" href="#">Pierna</a></h3>
    <div class="containerEjercicios" id="ejercicios-pierna" style="display: none;">
            <div class="card">
                <div class="card-body">
    ...
    <div>
        <h3 class="ejerciciosRutina"><a data-bs-toggle="#ejercicios-espalda" href="#">Espalda</a></h3>
    <div class="containerEjercicios" id="ejercicios-espalda" style="display: none;">
        <div class="card">
            <div class="card-body">
    ...
    <div>
        <h3 class="ejerciciosRutina"><a data-bs-toggle="#ejercicios-hombro" href="#">Hombro</a></h3>
    <div class="containerEjercicios" id="ejercicios-hombro" style="display: none;">
        <div class="card">
            <div class="card-body">
    ...
    <div>
        <h3 class="ejerciciosRutina"><a data-bs-toggle="#ejercicios-brazo" href="#">Brazo</a></h3>
    <div class="containerEjercicios" id="ejercicios-brazo" style="display: none;">
        <div class="card">
            <div class="card-body">
...
document.querySelectorAll('[data-bs-toggle]').forEach(item => {
    item.addEventListener('click', function() {
        var targetId = this.getAttribute('data-bs-toggle');
        var ejerciciosDiv = document.querySelector(targetId);
        if (ejerciciosDiv.style.display === 'none') {
            ejerciciosDiv.style.display = 'block';
            ejerciciosDiv.style.display = 'flex';
            ejerciciosDiv.style.justifyContent = 'space-around';
            ejerciciosDiv.style.flexWrap = 'wrap';
            ejerciciosDiv.style.maxWidth = '100vw';
        } else {
            ejerciciosDiv.style.display = 'none';
        }
    });
});
